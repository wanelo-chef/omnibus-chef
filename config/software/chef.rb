...
version("local_source") do
  source path: "#{project.files_path}/../../chef"
...
whitelist_file /libssp\.so\.0/
whitelist_file /libcrypto\.so\..+/
whitelist_file /libz\.so/
whitelist_file /libumem\.so\..+/
whitelist_file /libffi\.so\..+/
whitelist_file /libssl\.so\..+/
whitelist_file /libyaml-0\.so\..+/
